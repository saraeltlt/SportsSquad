...
class TabBarVC: UITabBar {
    ...
    private func addShape() {
        ...
        shapeLayer.fillColor = UIColor(named: K.MEDIUM_PURPLE)?.cgColor
    ...
    override func draw(_ rect: CGRect) {
        self.addShape()
        self.unselectedItemTintColor = UIColor(named: K.TAB_BAR_TINT)!
        self.tintColor = UIColor(named: K.TAB_BAR_TINT)!
    }
    ...
    func createPath() -> CGPath {
        ...
        path.addQuadCurve(to: CGPoint(x: centerWidth, y: height + 10), controlPoint: CGPoint(x: centerWidth - 20, y: height + 10)) //bottom left curve
